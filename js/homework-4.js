...
и index (вычитание).
*/
/*Массив 'numbers' должен создаваться с помощью функции-конструктора 
Array с аргументом - длиной массива 'array' */
/*
...
ли элемент первый раз в массиве (true) или этот элемент в массиве 
...
пустой массив numbers только теми элементами из массива array, для 
...
// console.log(inventory.add("John"));
